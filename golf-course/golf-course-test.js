...
describe('Golf Course', function () {
  it.only('should have a name and difficulty', function () {
  ...
  it.only('should have a total number of openings for the day', function () {
  ...
  it.only('should have some unique features', function () {
  ...
  it.only('should accept golfers if there is room available', function () {
  ...
  it.only('should not accept golfers if there is no room available', function () {
...
describe('Golfer', function () {
  it.only('should have a name and handicap', function () {
    var golfer = new Golfer({ name: 'Will', handicap: 21 });
    assert.equal(golfer.name, 'Will');
    assert.equal(golfer.handicap, 21);
  });

  it.only('should start out minimally frustrated', function () {
    var golfer = new Golfer({ name: 'Ryan', handicap: 19 });
    assert.equal(golfer.name, 'Ryan');
    assert.equal(golfer.frustration, 0);
  });

  it.only('should be able to calculate their average score by adding the given par to their handicap', function () {
  ...
  it.only('should become frustrated based on the course difficulty (HARD or MODERATE - golf is never easy)', function () {
  ...
  it.only('should gain confidence after more practice', function () {
  ...
  it.only('should be able to marvel at the features of a golf course', function () {
  ...
  it.only('should have their performance on a hole affect their frustration', function () {
