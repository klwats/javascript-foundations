...
describe('Hobbit', function() {
  ...
  it.only('should start out 0 years old', function() {
    var bilbo = new Hobbit({ name: 'Bilbo' });

    assert.equal(bilbo.age, 0);
  });

  it.only('should gain 1 year after every birthday', function() {
  ...
  it.only('should be considered a child at the age of 32', function() {
  ...
  it.only('should be considered an adult at 33', function() {
    var hobbit = new Hobbit({ name: 'Taylor' });
  ...
  it.only('should be considered old at the age of 101', function() {
  ...
  it.only('should be able to get the ring if its name is Frodo', function() {
