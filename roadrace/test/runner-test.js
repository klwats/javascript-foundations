...
describe("Runner", function() {
  ...
  it.only('should have a name and age', function() {
  ...
  it.only('should start without having run any miles', function() {
    var mike = new Runner('Mike', 36);
    var pam = new Runner('Pam', 33);
  ...
  it.only('should be able to run and log miles', function() {
    var mike = new Runner('Mike', 36);
    var pam = new Runner('Pam', 33);
  ...
  it.only('should be able to keep running and logging miles', function() {
    var mike = new Runner('Mike', 36);
    var pam = new Runner('Pam', 33);
  ...
  it.only('should start with fitness of 25 percent', function() {
    var mike = new Runner('Mike', 36);
    var pam = new Runner('Pam', 33);
  ...
  it.only('should gain 1 fitness for every 1 mile run', function() {
    var mike = new Runner('Mike', 36);
    var pam = new Runner('Pam', 33);
  ...
  it.only('should gain .5 fitness for every stretching session', function() {
    var mike = new Runner('Mike', 36);
    var pam = new Runner('Pam', 33);
  ...
  it.only('should gain fitness by stretching and running', function() {
    var mike = new Runner('Mike', 36);
    var pam = new Runner('Pam', 33);
  ...
  it.only('should keep the names of completed races', function() {
    var mike = new Runner('Mike', 36);
    var pam = new Runner('Pam', 33);
  ...
  it.only('should log the miles and update fitness when a race is Run', function() {
